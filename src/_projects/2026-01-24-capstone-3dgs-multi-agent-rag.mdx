...
deployedUrl: https://snu-kdt-kolon-capstone-project.vercel.app
features:
...
#역할 + 범위 + 핵심 기여 + 결과
responsibilities:
  - 메인: 프로젝트에서 팀장 겸 풀스택 개발자로서 클라이언트·서버·배포 전 과정을 주도하고, 멀티모달 세일즈 에이전트의 엔드투엔드 구현과 안정적 운영 기반을 구축함(기여도 100%)
  - 서브: 2D이미지/영상 데이터를 받으면 자동으로 3D 차량 이미지를 생성하는 파이프라인 구축함(기여도 50%)
pinned: true
mermaid: true
order: 0
---
...
<ImageGallery
  images={[
    { src: '/images/snu-kdt-capstone/k-masa_log_example.png', alt: '에이전트 응답 로그' },
...
| **3D** | 3D Gaussian Splatting(3DGS), CF3, Dyno, Colmap | | |
...
- Lee, H., Min, J., & Park, J. (2025). CF3: Compact and Fast 3D Feature Fields. arXiv. https://doi.org/10.48550/arXiv.2508.05254
- Qin, M., Li, W., Zhou, J., Wang, H., & Pfister, H. (2023). LangSplat: 3D Language Gaussian Splatting. arXiv. https://doi.org/10.48550/arXiv.2312.16084
- Guédon, A., & Lepetit, V. (2023). SuGaR: Surface-Aligned Gaussian Splatting for Efficient 3D Mesh Reconstruction and High-Quality Mesh Rendering. arXiv. https://doi.org/10.48550/arXiv.2311.12775
- Rackham, N. (1988). SPIN selling. McGraw-Hill.
- Thompson, R., & Bowen, C. J. (2009). Grammar of the shot. Focal Press.
- Kim, T., Lee, J., Yoon, S., Kim, S., & Lee, D. (2025). Towards personalized conversational sales agents: Contextual user profiling for strategic action. arXiv. https://doi.org/10.48550/arXiv.2501.xxxxx
- Raut, A., Tiwari, A., Das, S., Saha, S., Maitra, A., Ramnani, R., & Sengupta, S. (2023). Reinforcing personalized persuasion in task-oriented virtual sales assistant. PLoS ONE, 18(10), e0292437.
...
- Jafar, R. M. S., Ahmad, W., & Sun, Y. (2023). Unfolding the impacts of metaverse aspects on telepresence, product knowledge, and purchase intentions in the metaverse stores. Technology in Society, 72, 102165.
- Hwangbo, H. J., Kim, E. H., Lee, S. H., & Jang, Y. (2020). Effects of 3D virtual "try-on" on online sales and customers' purchasing experiences. IEEE Access, 8, 57442-57461.
