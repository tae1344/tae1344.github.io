...
metrics:
  ...
  - label: 캡스톤 기간
    value: 3개월
image:
  path: src/assets/img/snu-kdt-capstone/k-masa_overview.png
...
![시스템 핵심 구성요소](/src/assets/img/snu-kdt-capstone/k-masa_overview.png)

![시스템 아키텍처](/src/assets/img/snu-kdt-capstone/k-masa_architecture.png)

![3D 모델링](/src/assets/img/snu-kdt-capstone/3d-pipeline.png)

![3VVG: 3D Viewer Visual Grammar](/src/assets/img/snu-kdt-capstone/3VVG.png)
...
<ImageGallery
  images={[
    { src: '/src/assets/img/snu-kdt-capstone/user-evaluation-1.png', alt: 'SUS 평가 결과 요약' },
    { src: '/src/assets/img/snu-kdt-capstone/user-evaluation-2.png', alt: 'UEQ 감성/실용 품질 비교 결과' },
    { src: '/src/assets/img/snu-kdt-capstone/user-evaluation-3.png', alt: 'SUS 개선 항목 분석' },
    { src: '/src/assets/img/snu-kdt-capstone/user-evaluation-4.png', alt: 'UEQ 8문항 통계 분석 결과' },
  ]}
  columns={2}
/>
